      ...
      tableColumnHelper.accessor("rowtablehead", {
        cell: (info) => (
          ...
          <div className="flex justify-between items-center">
            <Heading
              as="h4"
              className={`flex justify-center items-center h-[36px] border-indigo-50 ${info?.getValue?.() === "Total Revenues" ? "font-bold" : ""}`}
              style={{ color: 'black' }}
            >
              {info?.getValue?.()}
            </Heading>
        ...
        cell: (info) => (
          <div className="flex justify-center md:w-full p-2 border-indigo-50">
            <Heading
              ...
              style={{ color: `${
                info?.getValue?.() == 'High' ? 'green' :
                info?.getValue?.() == 'Medium' ? '#CCB400' :
                info?.getValue?.() == 'Low' ? 'red' : 'white'
              }` }}
            >
            {info?.getValue?.()}
            </Heading>
      ...
      <div className="h-[1024px] w-full bg-white-A700_02 relative flex">
        ...
        <div className="flex flex-col w-[66%] top-[13%] right-0 left-0 m-auto absolute">
          ...
          />
            ...
            <Button className="flex items-center justify-center h-[39px] mt-[51px] ml-[1000px] px-[15px] mb-5 md:ml-0 sm:px-5 text-white-A700_01 text-center text-base font-medium bg-indigo-800 rounded-[3px]"
