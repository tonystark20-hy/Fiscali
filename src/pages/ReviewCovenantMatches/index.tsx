...
const tableData = [
  ...
  { rowtablehead: "Total other operating expenses, net", millionsofusd: "(3，336.）" },
          ...
          >
            ...
            >
              <div className="flex">
                <MenuItem
                  icon={
                    <Img src="images/img_fluentsearch16regular.svg" alt="fluentsearch" className="h-[16px] w-[16px]" />
                  }
                >
                  Search Company{" "}
                </MenuItem>
        ...
        <div className="flex md:flex-col justify-end items-start w-[82%] gap-6 pl-10">
          <div className="flex flex-col items-start md:self-stretch mt-14 md:p-5 flex-1">
            ...
            <Text size="md" as="p" className="mt-2.5 ml-2.5 md:ml-0">
              Please review line items and click on any row to amend. You will need to confirm all unchecked boxes
              before proceeding.{" "}
            </Text>
            ...
            <ReactTable
              ...
              data={tableData}
            />
                  <Button className="flex items-center justify-center h-[39px] mt-[51px] ml-[1300px] px-[15px] mb-5 md:ml-0 sm:px-5 text-white-A700_01 text-center text-base font-medium bg-indigo-800 rounded-[3px]"
